...
__all__ = ['plot_walk', 'plot_entire_walk', 'SideBar', 'app_sidebar', 'app_mainscreen', 'notebook_mainscreen', 'sb']
...
def app_mainscreen(APP_NAME, sb):
    ...
    # Load walking data
    walk_data, walk_date, walk_files = load_and_cache_raw_walk_data(sb.walk_name)
...
if in_notebook():
    ...
    map_handle, walk_data, walk_date = app_mainscreen(APP_NAME, sb)